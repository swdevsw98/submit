...
urlpatterns = [
    ...
    path('comment/<int:post_id>/<int:comment_id>/update/', et.updateComment, name='updateComment'),
    path('comment/<int:post_id>/<int:comment_id>/delete/', et.deleteComment, name='deleteComment')
