...
urlpatterns = [
    ...
    path('createComment/<int:post_id>/create/', et.createComment, name='createComment'),
    path('createComment/<int:post_id>/<int:comment_id>/update/', et.updateComment, name='updateComment'),
    path('createComment/<int:post_id>/<int:comment_id>/delete/', et.deleteComment, name='deleteComment')
